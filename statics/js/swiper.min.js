...
!(function(e, t) {
        ...
        ee = {
            ...
            extend: function() {
                ...
                for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
                    ...
                    if (null != s)
                        for (
                            var r = Object.keys(Object(s)), n = 0, o = r.length; n < o; n += 1
                        ) {
                            var l = r[n],
        ...
        slideTo: function(e, t, a, i) {
            ...
            return (
                ...
                (s.updateActiveIndex(r),
                    ...
                    "reset" !== h && (s.transitionStart(a, h), s.transitionEnd(a, h)), !1) :
                (0 !== t && te.transition ?
                    (s.setTransition(t),
                        s.setTranslate(v),
                        s.updateActiveIndex(r),
                ...
                attachEvents: function() {
                                    ...
                                    if (!(
                                        ...
                                        n.preventDefault(),
                                            ...
                                            (i.loop && t.loopFix(),
                                                ...
                                                (a.allowMomentumBounce = !1), !i.grabCursor ||
                                                (!0 !== t.allowSlideNext &&
                                                    !0 !== t.allowSlidePrev) ||
                                                t.setGrabCursor(!0),
                                            ...
                                            (i.touchReleaseOnEdges && (v = 0),
                                                ...
                                                ((h = !1),
                                                    ...
                                                    (a.currentTranslate =
                                                        t.minTranslate() -
                                                        1 +
                                                        Math.pow(-t.minTranslate() + a.startTranslate + u,
                                                            v
                                                        ))) :
                                                u < 0 &&
                    ...
                    (e.onTouchEnd = function(e) {
                        ...
                        if (
                            ...
                            for (
                                var M = 0, z = t.slidesSizesGrid[0], P = 0; P < o.length; P += i.slidesPerGroup
                            )
                ...
                preloadImages: function() {
                    ...
                    for (var a = 0; a < e.imagesToLoad.length; a += 1) {
                        ...
                        e.loadImage(
                            ...
                            i.sizes || i.getAttribute("sizes"), !0,
                            t
                        );
                    }
                },
        ...
        T = (function(u) {
            ...
            return (
                (((h.prototype = Object.create(u && u.prototype)).constructor =
                    ...
                    if (t.centeredSlides) {
                        for (
                            var o, l = a[r].swiperSlideSize, d = r + 1; d < a.length; d += 1
                        )
                            a[d] &&
                            !o &&
    ...
    var A = {
            ...
            normalize: function(e) {
                ...
                return (
                    ...
                    (1 === e.deltaMode ?
                        ...
                        ((i *= 800), (s *= 800))),
                    i && !t && (t = i < 1 ? -1 : 1),
                    s && !a && (a = s < 1 ? -1 : 1), { spinX: t, spinY: a, pixelX: i, pixelY: s }
                );
            },
                        ...
                        if (
                            (s.dynamicBullets &&
                                ((e.pagination.bulletSize = p
                                        .eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0)),
                                    i.css(
                ...
                if ((t.transition(e), a.params.virtualTranslate && 0 !== e)) {
                    ...
                    t.transitionEnd(function() {
                        if (!s && a && !a.destroyed) {
                            (s = !0), (a.animating = !1);
                            for (
                                var e = ["webkitTransitionEnd", "transitionend"], t = 0; t < e.length; t += 1
                            )
                                i.trigger(e[t]);
                        }
                    });
        ...
        K = {
            setTranslate: function() {
                for (
                    var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1
                ) {
                    var s = t.eq(i),
                        r = s[0].progress;
                    ...
                    click: function(e) {
                        ...
                        !a.params.navigation.hideOnClick ||
                            ...
                            (s ?
                                ...
                                r && (t = r.hasClass(a.params.navigation.hiddenClass)), !0 === t ?
